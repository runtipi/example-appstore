...
|---------------------------------------|------------------|-------------------|
| `/runtipi/app-data/`**store**`/radarr/data`   | `/config`          | directory of all your settings and database
